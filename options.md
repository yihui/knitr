...
- `renderto`: (`NULL`) possible values are `tex`, `html` and `jekyll`; it will be automatically determined based on the input file, and this option will affect which set of hooks to use
