...
If you will not be printing output, please leave one blank line at the end of your cell. See below for an example:
...
```{rb, eval = TRUE, freshHistoryRB =FALSE}
morpho
```
...
```
##    Missing Variable:	Variable phylogeny does not exist
##    Error:	Problem processing line 1 in file "rb2e6e1a5e3835.Rev"
```
...
```
##    Missing Variable:	Variable monitors does not exist
##    Error:	Problem processing line 1 in file "rb2e6e2681cd20.Rev"
```
