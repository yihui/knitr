...
1. I love RStudio and Sweave is sweet there; is **knitr** going to work with RStudio?
  - I love RStudio too, and yes, **knitr** is supported in RStudio thanks to RStudio developers; currently you can try the [preview version](http://www.rstudio.org/download/preview/). By the way, I also recommend LyX if you want to use Sweave or **knitr**.
