...
opts_chunk$set(fig.align='center', out.width='.6\\linewidth', fig.width=6, fig.height=6, par=TRUE)
options(width=90)
...
.knitr.author = if (exists('.knitr.author')) {
...
\Sexpr{if (exists('.knitr.title')) '\\maketitle'}
