...
% \SweaveOpts{prefix.string=figure/graphics-, prefix.cache=cache/graphics-, align=center, dev=tikz, external=TRUE, width=5, height=5, fig.show=hold, cache=TRUE, align=center, par=TRUE}
...
\begin{figure}
<<two-high,width=3,height=2,out.width=.49\linewidth>>=
plot(cars)
...
\begin{figure}
<<low-plot-loop,width=3,height=2.5,out.width=.49\linewidth,fig.keep=all>>=
...
\begin{figure}
<<high-with-low,width=3,height=2,out.width=.5\linewidth,fig.keep=all,fig.show=asis>>=
plot(cars)
...
\begin{figure}
<<fig-last,width=5.2,height=3,out.width=.7\linewidth,fig.keep=last>>=
...
\begin{figure}
<<clock-animation,width=3,height=3,out.width=.4\linewidth,fig.show=animate,tidy=FALSE,crop=TRUE>>=
par(mar = rep(3, 4))
...
\begin{figure}
<<maruko-plot,width=7,height=4,out.width=.45\linewidth,align=left,crop=TRUE>>=
...
\begin{figure}
<<math-formula-tt,width=6,height=2,out.width=\linewidth,echo=T>>=
...
\begin{figure}
<<pdf-nocrop,width=3.2,height=3.2,out.width=.4\linewidth>>=
test_crop=function(){
...
\begin{figure}
<<pdf-crop,echo=FALSE,width=3.2,height=3.2,out.width=.4\linewidth,crop=TRUE,dependson=pdf-nocrop>>=
test_crop()
@
