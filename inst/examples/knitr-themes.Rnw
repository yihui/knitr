...
\begin{abstract}
This manual%
\footnote{source code at \url{https://github.com/yihui/knitr/blob/master/inst/examples/knitr-themes.Rnw}%
...
\footnote{For a preview of all themes, see \url{https://gist.github.com/yihui/3422133}%
}:
