...
\item a set of out \href{http://yihui.name/knitr/hooks}{hooks} will also
be set up automatically according to the filename extension (e.g.
...
chunk depends on other chunks (see the \texttt{dependson} \href{http://yihui.name/knitr/options}{option})
...
features such as graphics in the website: \url{http://yihui.name/knitr/demos}.
...
\textbf{listings} package in the \href{http://yihui.name/knitr/demo/listings/}{website}
...
(see the demo ``\href{http://yihui.name/knitr/demo/reference/}{Chunk Reference}''
in the website).
...
output (see \href{http://yihui.name/knitr/demos}{demos in the website})
\end{description}
