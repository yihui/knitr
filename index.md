...
This package is still under development on  [GitHub](https://github.com/yihui/knitr); for installation instructions and FAQ's, see [README](https://github.com/yihui/knitr#readme). This website serves as the full documentation of **knitr**, and [a PDF manual](https://github.com/downloads/yihui/knitr/knitr-manual.pdf) can be found under the [Downloads](https://github.com/yihui/knitr/downloads) tab of the package repository.
