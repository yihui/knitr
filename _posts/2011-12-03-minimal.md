...
- GFM
  - md source: [knitr-minimal.Rmd](https://github.com/yihui/knitr/blob/master/inst/examples/knitr-minimal.Rmd)
...
- reStructuredText
  - source: [knitr-minimal.Rrst](https://github.com/yihui/knitr/blob/master/inst/examples/knitr-minimal.Rrst)
  - output: [knitr-minimal.rst](https://github.com/yihui/knitr/blob/master/inst/examples/knitr-minimal.rst)
