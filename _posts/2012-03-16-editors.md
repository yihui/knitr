...
subtitle: Work with Emacs, Texmaker, WinEdt and TextMate, etc
category: demo
---
...
Simon Potter has [an Emacs lisp script](http://sjp.co.nz/posts/emacs-ess-knitr/) which supports **knitr** and you might want to try it.
