...
#' @param copy Whether to copy the image files into the figure directory of the
#'   current chunk (using the same naming scheme as the plots generated by the
#'   chunk) and include the copies instead. This is useful when the images are
#'   in a temporary directory (e.g., generated by the \pkg{magick} package),
#'   which may not survive to the rendering step of output formats that do not
#'   embed images.
