...
#'
#' For every code chunk, if the chunk option named, say, `FOO`, is not
#' `NULL`, and a hook function with the same name has been set via
#' `opts_hooks$set(FOO = function(options) { options })` (you can manipuate
#' the `options` argument in the function and return it), the hook function
