...
- Added `with_opts` function to inherit chunk options with the `ref.label` option. For example, `ref.label='label'` just inherits codes, and `ref.label=with_chunk('label')` also inherits chunk options (thanks, @atusy #1960).
